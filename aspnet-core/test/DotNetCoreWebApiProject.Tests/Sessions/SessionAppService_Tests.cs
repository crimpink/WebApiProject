...
using Shouldly;
using Xunit;
using DotNetCoreWebApiProject.Sessions;

namespace DotNetCoreWebApiProject.Tests.Sessions
{
    public class SessionAppService_Tests : DotNetCoreWebApiProjectTestBase
    {
